...
public class CreateCustomer extends javax.swing.JPanel {
     ...
     */
    public CreateCustomer(JPanel userProcessContainer,EcoSystem ecosystem) {
        initComponents();
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
        ...
        if (ecosystem.getUserAccountDirectory().checkIfUsernameIsUnique(name)) {
            ...
            ecosystem.getCustomerDirectory().addCustomer(newCustomer); // add user to customer directory
